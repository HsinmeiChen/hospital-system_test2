...
def send_email_to_client(cleaned_data):
	...
	"""    
	subject = f"【長安醫院-神經醫學中心】客服信件 {cleaned_data['subject']}"

	# 用 Django template 渲染 HTML
	html_body = render_to_string('Neurology_Center/neuro-email-content.html', {
	...
	email = EmailMessage(
		...
		to=settings.CONTACT_EMAIL_RECIPIENTS_NEURO,
