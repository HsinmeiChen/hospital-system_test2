...
document.addEventListener('DOMContentLoaded', function () {
    ...
    initAjaxCardPagination({
        apiUrl: `/breast-care-center/api/doctor/${employeeId}/articles/`,
    ...
    // ========== 影音專區 ==========
    initAjaxCardPagination({
        apiUrl: `/breast-care-center/video-section/${employeeId}/`,
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    window.loadSidenav({
        apiUrl: '/breast-care-center/api/doctor_sidenav/',
        containerId: 'doctor-sidenav',
        isActiveFn: item => item.employee_id === currentDoctorId,
        buildHrefFn: item => `/breast-care-center/doctor/${item.employee_id}/`,
