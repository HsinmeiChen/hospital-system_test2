...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch('/breast-care-center/api/banner-data/')
        .then(res => res.json())
        .then(data => {
...
document.addEventListener("DOMContentLoaded", function () {
    fetch("/breast-care-center/api/breast-news-home/")
        .then(res => res.json())
        .then(data => {
            const newsSection = document.querySelector("#news .section-grid-sm");
...
// 影音專區
document.addEventListener("DOMContentLoaded", function () {
    fetch('/breast-care-center/api/breast-film-home/')
        .then(res => res.json())
        .then(res => {
...
// 媒體報導
document.addEventListener("DOMContentLoaded", function () {
    fetch("/breast-care-center/api/breast-media-home/")
        .then(res => res.json())
        .then(data => {
