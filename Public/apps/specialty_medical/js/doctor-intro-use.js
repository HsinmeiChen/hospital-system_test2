...
$('.open-stop-modal').on('click', function () {
    ...
    // Ajax 載入資料
    $.ajax({
        url: `/specialty_medical/api/stop-info/${empId}/`,
        method: 'GET',
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    initAjaxCardPagination({
        apiUrl: `/specialty_medical/api/doctor/${employeeId}/articles/`,
    ...
    // ========== 影音專區 ==========
    initAjaxCardPagination({
        apiUrl: `/specialty_medical/video-section/${employeeId}/`,
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    window.loadSidenav({
        apiUrl: '/specialty_medical/api/doctor_sidenav/',
        containerId: 'doctor-sidenav',
        isActiveFn: item => item.employee_id === currentDoctorId,
        buildHrefFn: item => `/specialty_medical/doctor/${item.employee_id}/`,
