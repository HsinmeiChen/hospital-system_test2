...
$('.open-stop-modal').on('click', function () {
    ...
    // Ajax 載入資料
    $.ajax({
        url: API_URL_STOP_INFO.replace('PLACEHOLDER', empId),
        method: 'GET',
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    initAjaxCardPagination({
        apiUrl: API_URL_DOC_ARTICLES.replace('PLACEHOLDER', employeeId),
    ...
    // ========== 影音專區 ==========
    initAjaxCardPagination({
        apiUrl: API_URL_DOC_VIDEOS.replace('PLACEHOLDER', employeeId),
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    window.loadSidenav({
        ...
        buildHrefFn: item => URL_DOC_DETAIL.replace('PLACEHOLDER', item.employee_id),
        renderTextFn: item => `
