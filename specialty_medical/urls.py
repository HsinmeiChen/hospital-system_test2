...
urlpatterns = [
    ...
    path('ort-main/', view=views.ort_main, name="home"), # 前台-首頁
    path('api/banner-data/', views.ort_banner_api, name='ort_banner_api'), # 首頁-Banner
    ...
    path("api/ort-news/", views.health_news_api, name="health_news_api"), # 最新消息-列表分頁(AJAX)
    path('health-news/<str:key>/', view=views.health_news_detail_view, name='health_news_detail'), # 最新消息-文章頁

    path('ort-media/', view=views.ort_media, name='health_media'), # 媒體報導列表-主頁
    path('api/ort-media/', views.ort_media_api, name='ort_media_api'), # 媒體報導-列表分頁(Ajax) 
    ...
    path('ort-health-film/', views.health_film, name='health_film'), # 「影音專區」 主頁
    ...
    path('ort-treatment/', views.treatment_list, name='treatment_list'), # 治療項目列表-主頁
    path('treatment/<str:url_name>/', views.treatment_article, name='treatment_article'), # 治療項目-文章頁
    path('api/treatment/sidenav/', views.treatment_sidenav_api, name='treatment_sidenav_api'),  # 治療項目文章頁-側邊選單(AJAX)
]
